...
// SI RECUERDO BIEN  <String> ESTA HACIENDO REFERENCIA A GENERICS 
...
Remember that a String in Java is an object (not a primitive type). To use other types, such as int, you must specify an equivalent wrapper 
